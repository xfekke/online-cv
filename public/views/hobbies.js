      ...
      <div class="hobbies-gallery">
        ${pokemonCards
          ...
          <div class="hobby-item">
            <img src="/online-cv/public/image/imagesHobbies/${image.file}" alt="${image.name}" class="hobby-image" onclick="openLightbox('/online-cv/public/image/imagesHobbies/${image.file}')">
        ...
        <div class="animation-gallery">
          ${animations
            ...
            <div class="animation-item">
              <img src="/online-cv/public/image/animations/${animation.file}" alt="${animation.name}" class="animation-gif" onclick="openLightbox('/online-cv/public/image/animations/${animation.file}')">
        ...
        <div class="portrait-gallery">
          ${portraits
            ...
            <div class="portrait-item">
              <img src="/online-cv/public/image/imagesHobbies/${portrait.file}" alt="Portrait" class="portrait-image" onclick="openLightbox('/online-cv/public/image/imagesHobbies/${portrait.file}')">
            </div>
          `
            )
            .join("")}
